...
import imagere from "../public/CAIMERA.jpg";
  ...
  return (
    <WavyBackground>
      ...
      <div className="flex space-x-4">
        {" "}
        <button
          className=" bg-mygreen hover:bg-orange-600 text-black font-bold py-2 px-4 rounded-lg"
          onClick={function () {
